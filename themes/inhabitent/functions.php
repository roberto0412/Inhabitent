...
function red_starter_scripts() {
	...
	wp_enqueue_script( 'red-starter-search', get_template_directory_uri() . '/build/js/search.min.js', array(), '20151234', true );
	wp_enqueue_script( 'red-starter-searrh', get_template_directory_uri() . '/build/js/fixed.min.js', array(), '20151234', true );
